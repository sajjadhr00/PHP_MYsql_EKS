...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:#000"> User Management</span></h2>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="27" bgcolor="#000"><span class="style10"><strong>Create New User</strong></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="25" bgcolor="#000"><span class="style10"><strong>User List</strong></span></td>
      </tr>
      <tr>
        <td><table width="100%" border="1" bordercolor="#000" >
            <tr>
              ...
              <th bgcolor="#c2c0c0" class="style3"><div align="left" class="style9 style5"><strong>UserName</strong></div></th>
