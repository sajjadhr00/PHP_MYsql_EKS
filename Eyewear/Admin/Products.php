      ...
      <tr>
        <td>&nbsp;
          <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="#000">
            <tr>
              <td bgcolor="#000"><span class="style12">ItemId</span></td>
              <td bgcolor="#000"><span class="style12">ItemName</span></td>
              <td bgcolor="#000"><span class="style12">Size</span></td>
              <td bgcolor="#000"><span class="style12">Image</span></td>
              <td bgcolor="#000"><span class="style12">Price</span></td>
              <td bgcolor="#000"><span class="style12">Discount</span></td>
              <td bgcolor="#000"><span class="style12">Total</span></td>
            </tr>
