  ...
  <div id="content">
    ...
    <table width="100%" border="1" bordercolor="#000" >
     <tr>
        ...
        <td bgcolor="#000" class="style10 style3"><strong>Name</strong></td>
      <td bgcolor="#000" class="style10 style3"><strong>Size</strong></td>
        <td bgcolor="#000" class="style10 style3"><strong>Quantity</strong></td>
        <td bgcolor="#000" class="style10 style3"><strong>Total</strong></td>
        <td bgcolor="#000" class="style10 style3"><strong>Image</strong></td>
        <td bgcolor="#000" class="style10 style3"><strong>Delete</strong></td>
      </tr>
      <?php
